  ...
  return (
    <div className="app">
      <div className="level">
        ...
        <button className="app__dark-mode-btn icon level-right" onClick={handleToggle}>
          <FontAwesomeIcon icon={isDarkMode ? faSun : faMoon} color={isDarkMode ? '#FFA500' : undefined}/>
        </button>
